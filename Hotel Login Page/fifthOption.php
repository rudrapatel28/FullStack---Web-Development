<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
         $iD = $_POST['reservationID'];
            ...
            $query = "SELECT * FROM PetOwnersData WHERE `Pet Owners ID` = $iD";
    ...
    <script type="text/javascript">
        function confirmPerksRequest() {
            ...
            if (reservationID === '') {
                ...
                var secondConfirmation = confirm("You are about to CANCEL Perks for your pet. Are you sure you want to do so?");
                alert('Perks Deleted');
...
<body>
	        <div class="container">
    <h1>Cancel Perks Form</h1>
    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
        <label for="reservationID">Pet Owner's Reservation ID:</label>
